...
Native iOS client for **[Librarium](https://librarium.press)**, a self-hosted, privacy-focused tracker for your physical book, manga, and comic collection. A self-hosted alternative to Libib and similar cloud catalog services. Free and AGPL 3.0; there is no paid tier. iOS Lite is next up.
...
| [`librarium-ios`](https://github.com/fireball1725/librarium-ios) ← **you are here** | Native iOS client · SwiftUI · iOS 26+ (TestFlight)                       |
...
Patches welcome; see [CONTRIBUTING.md](./CONTRIBUTING.md). Everyone who has landed code is on the [contributors list](https://github.com/fireball1725/librarium-ios/graphs/contributors).
